...
if __name__ == "__main__":
    ...
    save_content('data/trainset/llama_brief_llm.json', get_tutorcodeplus("llama", "brief_llm"))
    ...
    save_content('data/trainset/starchat_brief_llm.json', get_tutorcodeplus("starchat", "brief_llm"))
